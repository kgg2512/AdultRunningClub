...
> Google Play ASO — 상위 10개 키워드 (검색 가능성 + 브랜드 적합성 균형)

### 한국어 키워드

| 순위 | 키워드 | 전략적 이유 |
|------|--------|------------|
| 1 | 러닝 커뮤니티 | 가장 직접적인 검색어, 볼륨 큼 |
| 2 | 프리미엄 러닝 | 럭셔리 포지셔닝 직결 |
| 3 | 러닝 멤버십 | 카테고리 독점 (경쟁자 없음) |
...
### 메인 카테고리
**Health & Fitness (건강 및 피트니스)**

> 사유: 러닝은 피트니스 활동이며, Play Store 러닝/운동 검색 트래픽의 메인 허브.
> 경쟁자 대부분(Nike Run Club, Strava)이 이 카테고리에 있어 인지도 높은 검색자가 집중됨.
